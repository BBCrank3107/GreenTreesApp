    ...
    return (
        <SafeAreaView style={{ flex: 1 }}>
            <View style={{ flex: 1, alignItems: 'center' }}>
                ...
                <View style={{width: '100%', height: 80, justifyContent: 'center', alignItems: 'center', backgroundColor: 'green' }}>
                    <Text style={{ fontFamily: 'Merriweather-Regular', fontSize: 24}}>Chăm sóc cây trồng</Text>
                </View>
            </View>
        </SafeAreaView>
    );
